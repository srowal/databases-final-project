...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE persons SET firstName = ?, lastName = ?, dateOfBirth = ?, 
        ...
        WHERE SSN IN (SELECT SSN FROM familyMembers WHERE SSN = ?)";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("sssssssssss", $firstName, $lastName, $dateOfBirth, $medicareNumber, $phoneNumber, $address, $city, $province, $postalCode, $emailAddress, $SSN);
